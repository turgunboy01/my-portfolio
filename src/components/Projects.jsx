...
function Projects() {
  const [listProjects] = useState([
    ...
    },
    {
      ...
      des: "This website was created for the Food shop. Adaptive design, made for all devices.",
      mission: "Front-end Developer, system adaptive design",
      language: "HTML5, CSS3, React JS, Firebase,...",
      images: img6,
      link: "https://shop-ap.netlify.app/",
      github: "https://github.com/turgunboy01/shop-app",
    },
    {
      name: "Project Course App in website",
      des: "This website was created for the course aplication. Adaptive design, made for all devices.",
      mission: "Front-end Developer, adaptive design",
      language: "HTML5, CSS3, React JS, Firebase,...",
      images: img7,
      link: "https://cours-app.netlify.app",
      github: "https://github.com/turgunboy01/course-app",
    },
    {
    ...
    {
      name: "Project GMT in website",
      des: "This website was created for the GMT Shop app. Adaptive design, made for all devices.",
      mission: "Front-end Developer, adaptive design",
      language: "HTML5, CSS3, React JS, Clerk,...",
      images: img9,
      link: "https://examen-8.vercel.app/",
      github: "https://github.com/turgunboy01/examen-8",
    },
  ]);
  const divs = useRef([]);
